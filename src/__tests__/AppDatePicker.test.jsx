...
describe('AppDatePicker', () => {
  test('affiche le label et ouvre le calendrier au clic', () => {
    render(<AppDatePicker label='Date de test' name='testDate' value='2024-06-01' onChange={() => {}} />)
  ...
  test("appelle onChange lors de la sélection d'une date", () => {
    ...
    render(<AppDatePicker label='Date de test' name='testDate' value='2024-06-01' onChange={handleChange} />)
    // Ouvre le calendrier
    fireEvent.click(screen.getByLabelText(/Date de test/i))
