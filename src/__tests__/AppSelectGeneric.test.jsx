...
describe('AppSelectGeneric', () => {
  ...
  test('affiche le label', () => {
    render(<AppSelectGeneric id='select-test' label='Test Select' name='testSelect' value='' onChange={() => {}} options={options} />)
  ...
  test("appelle onChange lors d'un changement de sélection", () => {
    ...
    render(<AppSelectGeneric id='select-test' label='Test Select' name='testSelect' value='option1' onChange={handleChange} options={options} />)
  ...
  test('le champ est requis si required est true', () => {
    render(<AppSelectGeneric id='select-test' label='Test Select' name='testSelect' value='' onChange={() => {}} options={options} required />)
